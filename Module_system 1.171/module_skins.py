...
skins = [
    ...
    ("woman", skf_use_morph_key_10, "woman_body",  "woman_calf_l", "f_handL", "female_head", woman_face_keys,
     ["woman_hair_p","woman_hair_n","woman_hair_o","woman_hair_q","woman_hair_r","woman_hair_t","woman_hair_s","hairmessy","shortlayer","shoulderhair","shortbob","shortcut","ponytail","longshoulder","longstraight","straightshoulder","slickedback","maidenhair","courthair"], #woman_hair_meshes
