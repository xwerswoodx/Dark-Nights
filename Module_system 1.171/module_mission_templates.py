...
dedal_tavern_animations = (
    ti_on_agent_spawn,1,0,[
        ...
        (try_begin),
          (is_between,":troop", "trp_musician_male", "trp_musicians_end"),
          (try_begin),
...
#INVASION MODE END
  ...
  (
    ...
    ("multiplayer_duel",mtf_battle_mode, -1, "You lead your men to battle.", [
        (0,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      (1,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      (2,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      (3,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
  ...
  ("ship_battle", mtf_battle_mode,-1, "You close in and board the enemy ships", [
    ...
    ## UID: 11 - Begin
    #
  ("bandit_camp", mtf_battle_mode|mtf_synch_inventory, charge, "Ambushing a bandit camp", [
      (0,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (1,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (2,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (3,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (4,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (5,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (6,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (7,mtef_attackers|mtef_team_1,0,aif_start_alarmed,20,[]),
      (8,mtef_defenders|mtef_team_0,0,aif_start_alarmed,20,[]),
      (9,mtef_defenders|mtef_team_0,0,aif_start_alarmed,20,[]),
      (10,mtef_defenders|mtef_team_0,0,aif_start_alarmed,20,[]),
      (11,mtef_defenders|mtef_team_0,0,aif_start_alarmed,20,[]),
      (12,mtef_defenders|mtef_team_0,0,aif_start_alarmed,20,[]),
      (13,mtef_defenders|mtef_team_0,0,aif_start_alarmed,20,[]),
...
##              (display_message, "@X: {reg0}"),
  ...
  ## UID: 11 - End
    ...
    ## UID: 80 - Begin
    #
    ("deer_hunting", mtf_battle_mode, -1, "You lead your deers to battle.", [
        (1,mtef_team_0|mtef_leader_only,0,aif_start_alarmed,12,[]),
        (4,mtef_visitor_source,0,aif_start_alarmed,0,[]),
    ], [
        (ti_tab_pressed, 0, 0, [(change_screen_map)], []),
        ...
        (5, 0, 0, [(neg|agent_is_alive,"$leading_deer")], [
            (try_for_agents,reg(1)),
              (agent_get_item_id,reg(2),reg(1)),
              (eq,reg(2),"itm_deer"),
    ...
    ("boar_hunting", mtf_battle_mode, -1, "You lead your boars to battle.", [
        (1, mtef_team_0|mtef_leader_only, 0, aif_start_alarmed, 12, []),
        (4, mtef_visitor_source, 0, aif_start_alarmed, 0, []),
    ], [
        (ti_tab_pressed, 0, 0, [(change_screen_map)], []), #leaving area
