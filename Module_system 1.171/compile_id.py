...
print(colors.lred + "Dark Nights new compiling system. (v0.1.85)")
...
def compile_ids():
    ...
    print(colors.dgreen + "Initialization completed in " + colors.dred + diff_time + colors.dgreen + " milliseconds.")
