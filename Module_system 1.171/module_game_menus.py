...
##        (party_set_ai_behavior, "$g_encountered_party", ai_bhvr_driven_by_party),
  ...
  ("simple_encounter", mnf_enable_hot_keys|mnf_scale_picture, "{s2} You have {reg10} troops fit for battle against their {reg11}.", "none", [
...
##          ]),
      ...
      ("sail_from_port", [
          ...
          (else_try),
            (party_set_slot, "$current_town", slot_town_near_shore, 0),
          (try_end),
