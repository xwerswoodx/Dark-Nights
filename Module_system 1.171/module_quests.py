...
quests = [
    ...
    #("rescue_lady_under_siege", "Rescue {s3} from {s4}", qf_random_quest, "{s1} asked you to rescue his {s7} {s3} from {s4} and return her back to him."),
    #("deliver_message_to_lover", "Deliver Message to {s3}", qf_random_quest, "{s1} asked you to take a message to his lover {s3} at {s4}."),
    #("bring_prisoners_to_enemy", "Bring Prisoners to {s4}", qf_random_quest, "{s1} asked you to bring {reg1} {s3} as prisoners to the guards at {s4}."),
    #("bring_reinforcements_to_siege", "Bring Reinforcements to the Siege of {s5}", qf_random_quest, "{s1} asked you to bring {reg1} {s3} to {s4} at the siege of {s5}."),
    #("deliver_supply_to_center_under_siege", "Deliver Supplies to {s5}", qf_random_quest, "TODO: Take {reg1} cartloads of supplies from constable {s3} and deliver them to constable {s4} at {s5}."),
    ...
    #("capture_messenger", "Capture {s3}", qf_random_quest, "{s1} asked you to capture a {s3} and bring him back."),
    #("bring_back_deserters", "Bring {reg1} {s3}", qf_random_quest, "{s1} asked you to bring {reg1} {s3}."),
    ...
    #("capture_conspirators", "Capture Conspirators", qf_random_quest, "TODO: {s1} asked you to capture all troops in {reg1} conspirator parties that plan to rebel against him and join {s3}."),
    #("defend_nobles_against_peasants", "Defend Nobles Against Peasants", qf_random_quest, "TODO: {s1} asked you to defend {reg1} noble parties against peasants."l),
    ("incriminate_loyal_commander", "Incriminate the Loyal Commander of {s13}, {s16}", qf_random_quest, "{!}None"),
    #This is now a dynamic quest, integrated into the provocation system 
    #("raid_caravan_to_start_war", "Raid {reg13} Caravans of {s13}", qf_random_quest, "None"),
    ...
    #("hunt_down_raiders", "Hunt Down Raiders",qf_random_quest, "{s1} asked you to hunt down and punish the raiders that attacked a village near {s3} before they reach the safety of their base at {s4}."),
